...
\begin{center}
\keepXColumns
\noindent\begin{tabularx}{\linewidth}{|p{1in}|X|X|X|p{1in}|}\hline
...
\hline
HUDController & javafx controller & Handles actions and events triggered in hud scene & hud.fxml & None\\
\hline
