...
\usepackage{hhline}
\usepackage{hyperref}
\hypersetup{pdftex, colorlinks=true, linkcolor=blue, citecolor=blue, filecolor=blue, urlcolor=blue, pdftitle=TEST PLAN TEMPLATE, pdfauthor=Clinton Jeffery, pdfsubject=, pdfkeywords=}
