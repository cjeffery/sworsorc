...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        unit1.setUnitType(UnitType.Character);
        System.out.println(unit1.getRace().toString() + " moved into a hex that contains: ");
        ...
        System.out.println("with a movement cost of: " + hex2.getMovementCost(unit1));
        System.out.println("and a combat bonus of: *" + hex2.getCombatMultiplier(unit1));
                */
    }
}
