...
package implement_spells.spells.PL_6;
 ...
 */
public final class Berserkergang {
    JFrame frame;
    
    public Berserkergang(){
        prepareGUI();
    }
    
    public void prepareGUI(){
        frame = new JFrame("Berserkergang");
        ...
        JLabel notice = new JLabel("This is Berserkergang");
